...
import { Button, Eyebrow, Icon, Reveal, SectionHead, usePageMeta } from "../components/ui";
import { CTASection } from "../components/cards";

export default function About() {
  usePageMeta(
    "About Dr. Adeel — Urologist in Darbhanga | ZivRA HEALTH",
    "Dr. Adeel, BUMS — urologist with 15+ years of experience, practising patient-centred urology care in Darbhanga, Bihar."
  );
            ...
            <div>
              ...
              <Reveal delay={250}>
                <p className="mt-7 max-w-xl text-[15.5px] leading-relaxed text-ink-500 md:text-base">
                  A urologist who believes the best medicine begins with
                  listening. For over 15 years, Dr. Adeel has helped patients
                  in and around {site.location} navigate urological concerns
                  with clarity, patience and privacy.
                </p>
              </Reveal>
              <Reveal delay={330}>
            ...
            <div>
              ...
              <Reveal delay={140}>
                <p className="mt-6 text-[15px] leading-relaxed text-ink-500">
                  Dr. Adeel holds a {site.qualification} (Bachelor of Unani
                  Medicine and Surgery) and has dedicated more than 15 years of
                  professional experience to urological practice as a
                  urologist. His work covers the full breadth of everyday
                  urological concerns — from urinary and bladder health to
                  kidney and prostate matters.
                </p>
                <p className="mt-4 text-[15px] leading-relaxed text-ink-500">
                  What defines his practice is not a single technique, but a
                  consistent habit: every patient is heard fully before
                  anything else happens. No symptom is dismissed as small, no
                  question is too basic, and no explanation is complete until
                  the patient actually understands it.
                </p>
              </Reveal>
              <Reveal delay={220}>
          ...
          <div className="grid items-center gap-10 md:grid-cols-[auto_1fr]">
            <Reveal>
              <p className="font-display text-7xl font-extrabold tracking-tight text-ivory-50 md:text-8xl">
                15<span className="text-gold-400">+</span>
              </p>
            </Reveal>
            <Reveal delay={120}>
              ...
              <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-ivory-100/70">
                Fifteen years of professional experience is not just a number —
                it means a wide range of concerns seen, understood, and
                communicated honestly. It is the foundation on which every
                consultation at ZivRA HEALTH is built.
              </p>
            </Reveal>
          </div>
        </div>
        ...
        <div className="container-x">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            <div className="order-1 lg:order-2">
              ...
              <Reveal delay={140}>
                <p className="mt-6 text-[15px] leading-relaxed text-ink-500">
                  Urological concerns are often sensitive, and patients delay
                  them for years out of awkwardness or fear of being judged.
                  Patient-centred care means removing both — with privacy,
                  patience and a manner that never makes you feel small.
                </p>
              </Reveal>
