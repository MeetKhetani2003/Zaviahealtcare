import { PHOTO, processSteps, site } from "../data/content";
...
export default function HowItWorks() {
  usePageMeta(
    "How It Works — Your Care Journey | ZivRA HEALTH",
    "From booking to follow-up — the calm, four-step journey of urological care at ZivRA HEALTH, Darbhanga, Bihar."
  );
