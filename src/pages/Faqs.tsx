import { faqCategories, site } from "../data/content";
import { Accordion, Button, Icon, Reveal, usePageMeta } from "../components/ui";
import { CTASection, ImageHero } from "../components/cards";
import { IMG } from "../assets";

export default function Faqs() {
  usePageMeta(
    "FAQs | ZivRA HEALTH — Urologist in Darbhanga",
    "Answers to common questions about urology consultations, booking, privacy and the ZivRA HEALTH clinic in Darbhanga, Bihar."
  );
          ...
          <Reveal delay={150} className="mt-14">
            <div className="flex flex-col items-center justify-between gap-6 rounded-[2rem] bg-forest-900 px-8 py-10 text-center md:flex-row md:text-left">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button to="/book-consultation" variant="lightOutline">
                  Book Consultation
                </Button>
              </div>
            </div>
