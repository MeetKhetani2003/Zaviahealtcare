...
import { disclaimer, getTreatment, site, treatments } from "../data/content";
import {
  Accordion,
  Button,
  Icon,
...
export default function TreatmentDetail() {
  ...
  usePageMeta(
    t ? `${t.title} | ZivRA HEALTH — Darbhanga` : "Treatment | ZivRA HEALTH",
    t
      ? `${t.short} Consult Dr. Adeel, urologist in Darbhanga, Bihar. Book: ${site.phone}.`
      : undefined
  );
              ...
              <Reveal>
                <div className="rounded-3xl bg-forest-900 p-6">
                  ...
                  <div className="mt-5 space-y-2.5">
                    <Button to="/book-consultation" variant="light" className="w-full">
                      Book Consultation
                    </Button>
                    <Button
                      href={site.phoneHref}
