import { PHOTO, treatments } from "../data/content";
...
export default function Treatments() {
  usePageMeta(
    "Treatments & Care | ZivRA HEALTH — Darbhanga",
    "Personalised urology care in Darbhanga, Bihar — consultation and care guidance for kidney stones, prostate health and urinary & bladder concerns."
  );
      ...
      <section className="py-20 md:py-28">
        <div className="container-x">
          <SectionHead
            ...
            text="Every area below has its own detailed page. All care plans are individual — decided after, never before, a proper consultation."
          />
