...
export const homeFaqs: Faq[] = [
  {
    ...
    a: "If you're experiencing persistent urinary symptoms, pain, blood in urine, or concerns about kidney, prostate or bladder health, a urology consultation is a good idea. You don't need to wait until a symptom becomes severe — early conversations are often the most useful.",
  },
  {
    q: "How can I book a consultation?",
    a: `You can book by calling ${site.phone}, or by filling the consultation form on our Book Consultation page. Our team will reach out to confirm a convenient time for you.`,
  },
  {
    q: "What should I bring to my appointment?",
    a: "Any previous reports, test results or prescriptions related to your concern, along with a list of medicines you currently take. Arriving with these helps make the consultation more focused.",
  },
  {
    q: "Can I discuss sensitive concerns privately?",
    a: "Completely. Privacy is central to urological care. Consultations are one-to-one, and everything you share is treated with confidentiality.",
  },
  {
    q: "Where is ZivRA HEALTH located?",
    a: `ZivRA HEALTH is located at ${site.address}. You can open the exact location in Google Maps from our Contact page.`,
  },
  {
    q: "How can I contact Dr. Adeel?",
    a: `You can reach out on ${site.phone} or email ${site.email}. For appointment requests, the book consultation form is the fastest route.`,
  },
];
